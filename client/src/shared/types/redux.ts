...
function whatAction<stateType extends PendingAction | RejectedAction | FulfilledAction> (state: RequestStates) {
...
// export function isRejectedAction (sliceName: SliceNames) {
// 	return (action: AnyAction): action is RejectedAction => {
// 	return action.type.endsWith(RequestStates.rejected) && action.type.startsWith(sliceName)
// }